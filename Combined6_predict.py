...
expect_points = 42.0     # Expected total points for calculating point differential (45.4 was 2016 league average points/game)
                 ...
                 if game['neutral'] == 1:
                     ...
                     game['point_diff2'] = round(
                         (y_factor * (abs(((expect_points * game['my_prob1']) - (expect_points / 2))))) ** (
                                 1 / x_factor), 1)
                     game['point_diff3'] = round(-15.25 + (game['my_prob1'] * 30.7),2)
